...
- 참조: MI-0002, BA-0002, ADR-0014, SPEC-0003 (Shareable URL), SPEC-0004 (Import & Audit)
...
> **진행 상황 업데이트**: 2026-04-30 기준 (1.4.0 릴리즈 완료)
...
### 1.4.0 누적 완료 사항 (2026-04-30 기준)

P0 + P0.5 그룹의 핵심 기능이 모두 완료되어 **MVP + 첫 확장 사이클이 마감**된 상태:
...
남은 우선순위 후보는 P0.5 잔여 항목(Tailwind/Husky/GitHub Actions 생성기 + 옵션 툴팁) 또는 P1(AI 도구 설정 파일, CLI, Popular choices) 그룹.
